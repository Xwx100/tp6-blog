	...
	<div class="form_container">
		<div class="manage_tip">
			...
			<el-form :model="loginUser" status-icon :rules="rules" ref="loginForm" class="loginForm" label-width="80px">
				<el-form-item label="账号" prop="user_name_en">
					<el-input v-model="loginUser.user_name_en" placeholder="请输入账号"></el-input>
				</el-form-item>
  ...
  data () {
	return {
	  loginUser: {
		...
		rules: {
			user_name_en: [
				{ type: 'string',required: true,message: '账号格式不正确', trigger: 'blur' }
			],
			password: [
